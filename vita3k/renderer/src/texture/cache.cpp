...
void TextureCache::upload_texture(const SceGxmTexture &gxm_texture, MemState &mem) {
    ...
    while (face_uploaded_count < face_total_count && org_width > 0 && org_height > 0) {
        ...
        case SCE_GXM_TEXTURE_BASE_FORMAT_SE5M9M9M9:
            ...
            if (is_vulkan)
                break;
            texture_data_decompressed.resize(static_cast<size_t>(pixels_per_stride * memory_height * 6));
        ...
        case SCE_GXM_TEXTURE_BASE_FORMAT_U2F10F10F10:
            ...
            if (!is_vulkan)
                break;
            texture_data_decompressed.resize(static_cast<size_t>(pixels_per_stride * memory_height * 8));
        ...
        if (texture_type != SCE_GXM_TEXTURE_LINEAR && texture_type != SCE_GXM_TEXTURE_LINEAR_STRIDED && !gxm::is_pvrt_format(base_format)) {
            ...
            texture_pixels_lineared.resize(static_cast<size_t>(pixels_per_stride * memory_height * bytes_per_pixel));
